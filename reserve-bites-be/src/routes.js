...
function routes(app) {
  ...
  app.post("/restaurant/review", verifyAccessToken, restaurantController.postReview);
  ...
  app.get("/restaurant/suggest-for-user", verifyAccessToken, restaurantController.getSuggestForUser);
  ...
  app.get("/restaurant/:id/reservations", verifyAccessToken, verifyOwner, paginator, restaurantController.getRestaurantReservations);
